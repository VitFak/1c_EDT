...
Функция ПараметрыЗакрытия()
	...
	Если Результат.ОсновнойОбъектАдресации <> Неопределено И Результат.ОсновнойОбъектАдресации = "" Тогда
		Результат.ОсновнойОбъектАдресации = Неопределено;
	КонецЕсли;
	
	Если Результат.ДополнительныйОбъектАдресации <> Неопределено И Результат.ДополнительныйОбъектАдресации = "" Тогда
		Результат.ДополнительныйОбъектАдресации = Неопределено;
	КонецЕсли;
